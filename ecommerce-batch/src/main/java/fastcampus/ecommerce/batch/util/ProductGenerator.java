...
public class ProductGenerator {
  ...
  public static void main(String[] args) {
    ...
    try (FileWriter fw = new FileWriter(csvFilePath);
        CSVPrinter printer = new CSVPrinter(fw, CSVFormat.DEFAULT.builder()
            .setHeader(
  ...
  private static ProductUploadCsvRow randomProductRow() {
    ...
    String[] MANUFACTUERES = {"삼성전자", "LG전자", "나이키코리아", "아모레퍼시픽", "현대자동차", "BMW코리아", "롯데제과",
